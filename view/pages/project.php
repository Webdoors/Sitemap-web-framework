<?php
$q1=mysqli_query($con,"SELECT t1.* FROM gallery as t1 LEFT JOIN sitemap as t2 ON(t2.id=t1.sitemapid) WHERE t2.slug_$L='$p3' ");
...
/>
<section class="page-title" style="background-image: url('https://eventrox-react.expert-themes.com/images/background/5.jpg');">
        ...
        <div class="blog-single">
          <div class="news-block">
            <div class="inner-box">
              <div class="image-box">
                <figure class="image">
                  <img src="<?=$r1["img_$L"]?>" class="w-50" alt="image">
                </figure>
              </div>
              <div class="lower-content">
                <ul class="post-info d-none">
                  ...
                  <li>
                    <span class="far fa-comments"></span> Comment 3
                  </li>
                </ul>
                <h2><?=$r1["name_".$L]?></h2>
                <div>
      ...
      <div class="sidebar-side col-lg-4 col-md-12 col-sm-12">
        <aside class="sidebar padding-left">
          <div class="sidebar-widget popular-posts">
            <h4 class="sidebar-title">ფოტო</h4>
            <div class="widget-content row">
<?php
$q22=mysqli_query($con,"SELECT * FROm galleryimgs WHERE postid='".$r1["id"]."' AND img not like '%mp4%' ORDER BY id DESC ");
while($r22=mysqli_fetch_array($q22)){
	$name=explode("/",$r22["img"]);
	$name=end($name);
?>
              <article class="post col-4">
                <div class="post-inner">
                  <figure class="post-thumb w-100 bg-dark">
                    <a data-fancybox="gallery" title="<?=$name?>" href="<?=$r22["img"]?>" >
                      <img style="width:110px;height:110px" src="<?=strpos($r22["img"],"mp4")?"/img/p.png":$r22["img"]?>" class="w-100" alt="image">
                    </a>
                  </figure>
...
?>
          ...
          <div class="sidebar-widget popular-posts">
            <h4 class="sidebar-title">ვიდეო</h4>
            <div class="widget-content row">
<?php
$q22=mysqli_query($con,"SELECT * FROm galleryimgs WHERE postid='".$r1["id"]."' AND img like '%mp4%' ORDER BY id DESC ");
while($r22=mysqli_fetch_array($q22)){
	$name=explode("/",$r22["img"]);
	$name=end($name);
?>
              <article class="post col-12">
                <div class="post-inner">
                  <figure class="post-thumb w-100 bg-white" style="background:url('<?=$r22["thumb"]?>') no-repeat;background-size: contain!important;background-position: center!important;" >
                    <a data-fancybox="gallery" title="<?=$name?>" href="<?=$r22["img"]?>" >
                      <img style="width: auto !important;height: 174px;margin: auto;" src="<?=strpos($r22["img"],"mp4")?"/img/p.png":$r22["img"]?>" class="w-100" alt="image">
                    </a>
                  </figure>
                </div>
              </article>
