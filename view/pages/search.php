...
<div id="search_widget" class="search-widget" data-search-controller-url="//innovatorythemes.com/prestashop/INNO01/INNO1019_Revolve/IT19/en/search"><div class="innovatory-search"><form method="get" action="//innovatorythemes.com/prestashop/INNO01/INNO1019_Revolve/IT19/en/search"><input type="hidden" name="controller" value="search"><input type="text" name="s" value="" placeholder="Search here"><button type="submit"><i class="ti-search"></i></button></form></div></div>
<!-- /Block search module TOP -->
    </div><div class="clearfix"></div>
    <div class="text-center"><a href="https://innovatorythemes.com/prestashop/INNO01/INNO1019_Revolve/IT19/en/" class="btn btn-primary">Back Home &nbsp; <i class="fa fa-angle-right"></i></a></div>
