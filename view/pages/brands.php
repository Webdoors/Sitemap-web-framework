...
<nav data-depth="1" class="breadcrumb">
  ...
  <li class="brand">
    <div class="brand-img left-side col-xs-12 col-sm-3">
      <a href="?page=view"><img src="prestashop/img/samsung.webp" alt="Amongst Kitchen"></a>
    </div>
    <div class="brand-infos middle-side col-xs-12 col-sm-5">
      <h3><a href="#">SAMSUNG</a></h3>    
      <p class="brand-description"><p>Since 2002, Bristox offers a large choice of quality posters, available on paper and many other formats.</p></p> 
    </div>
